...
//             <h2>Yay!!! Steve&#39;s Portfolio Site!!!</h2>
...
const homePage = {
    ...
    <img src="/public/img/logo_black_300x60.gif">
    ...
    <div class="jumbotron backgroundImg">
    <div class="container-fluid">
    <div class="row">
    <p class="text">Steve&#39;s Portfolio</p>
    </div>
    </div>
    </div>
    </div>
...
const aboutPage = {
    ...
    <h1 class="hdr-text">About Steve</h1>
    <h2 class="content">Steve is an awesome designer, developer and all-round guy! </h2>
    </div>
    </section>`
}
const portfolioPage = {
    ...
    <img src="/public/img/slide1.jpg" alt="Los Angeles" style="width:100%;">
    </div>

    <div class="item">
    <img src="/public/img/slide2.jpg" alt="Chicago" style="width:100%;">
    </div>

    <div class="item">
    <img src="/public/img/slide3.jpg" alt="New york" style="width:100%;">
    </div>
    </div>
